    ...
    <>
      ...
      <div className="flex flex-col md:flex-row w-full max-w-5xl mx-auto my-10 bg-white shadow-lg rounded-xl overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-6 text-gray-800">
          ...
          <table className="w-full text-sm">
            <tbody>
              <tr className="flex justify-between">
                <td>{place.price} × 2 تذاكر</td>
                <td>{place.price * 2} دينار</td>
              </tr>
          ...
          <button     onClick={handleClick}  className="w-full bg-blue-600 text-white py-3 rounded text-lg mt-4 hover:bg-blue-700">
            إتمام الحجز بأمان
          </button>
        </div>
      </div>
